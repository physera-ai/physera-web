...
export default function CareersPage() {
  return (
    <main className="flex w-full max-w-[1320px] flex-1 flex-col px-3 py-1 sm:px-4">
      <article className="rounded bg-[var(--bench-panel)] px-5 py-16 sm:px-16 sm:py-24">
        <div className="mx-auto flex max-w-[720px] flex-col gap-6">
          <h1 className="font-serif text-[clamp(2.2rem,5vw,3.4rem)] leading-[1.05] tracking-[-0.04em] text-[var(--bench-ink)]">
            Come build with us
          </h1>

          <div className="mt-2 flex flex-col gap-5 text-[18px] leading-relaxed text-[var(--bench-ink-2)]">
            <p>
          ...
          <div className="flex flex-wrap gap-3 pt-4">
            <a
              ...
              className="inline-flex h-8 items-center rounded-full bg-[var(--bench-ink)] px-3.5 text-[16px] font-medium tracking-[-0.32px] text-[var(--bench-on-ink)] transition-opacity hover:opacity-85"
            >
              Email us
            </a>
